    ...
    public function roa_coa_print(Request $request, $id, $type = null)
    {
        ...
        try {
            ...
            $data = Booking::select(
                ...
                ->with('customer_data:id,company_name,user_name')
                ->with('customer_contact_data:id,mst_customer_id,street_1,street_2,area,pin,city,state,country')
            ...
            //     }
            // }
            return Helper::response("Data Shown Successfully For Roa\Coa", Response::HTTP_CREATED, true, $data);
        } catch (Exception $e) {
            $data = array();
