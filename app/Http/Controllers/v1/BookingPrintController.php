...
class BookingPrintController extends Controller
{
        ...
        try {
            ...
            if (!empty($data[0]['tests_data'])) {
                ...
                if ($type === "COA_PRINT" or $type === "NABL_PRINT" or $type === "COA_AYUSH" or $type === "Check_Coa") {
                    return $this->COA_PRINT($id, $type, $data, $can_coa_print, $print_allows);
                }
                ...
                if ($is_present == true) {
                    return $this->ROA_PRINT($id, $type, $data, $can_coa_print, $print_allows);
                }
     ...
     * @return \Illuminate\Http\Response
     */
    public function COA_PRINT($id, $type = null, $data, $can_coa_print, $print_allows)
    {
        //
        if ($can_coa_print == 1) {
            ...
            $rules = [
                ...
                'tests_data.*.date_of_performance_test' => "required",
            ...
            $msg = [
                "tests_data.*.approval_date_time.required"  => "Test Approval Date Time Must Be Required.",
                "tests_data.*.date_of_performance_test.required" => "Date Of Performance of the Test are Required.",
                ...
                'tests_data.*.result.required' => "Test Result Must Be Required For COA Print"
            ];
    ...
    public function ROA_PRINT($id, $type, $data, $can_roa_print, $print_allows)
    {
        ...
        if ($can_roa_print == 1) {
            ...
            $msg = "No Tests Are Allowed In Pending For ROA Generation.";
            return Helper::response($msg, Response::HTTP_OK, false);
        }
    }
